...
The organization needed to migrate to cloud within 18 months without disrupting
$2B in annual transaction processing.

---

## Solution Architecture

### Discovery & Assessment Phase (Months 1–2)

Used Azure Migrate to assess all 47 applications across four disposition categories:

| Disposition | Count | Strategy |
|---|---|---|
| Rehost (Lift & Shift) | 18 | Migrate VMs to Azure with minimal changes |
...
- **Hub-spoke network topology** — Azure Firewall Premium as central inspection point
- **Azure Policy initiatives** — CIS Azure Benchmark v2.0 enforced at scale
- **Centralized logging** — Log Analytics Workspace with 90-day retention
- **Identity** — Azure AD Connect sync from on-premises Active Directory
...
The security team was unfamiliar with shared responsibility model in cloud.
